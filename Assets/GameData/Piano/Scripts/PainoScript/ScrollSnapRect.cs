...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    void Start() {
        ...
        transform.GetChild(6).transform.GetChild(_currentPage).transform.localScale = new Vector3(0.85f, 0.85f, 0.85f);
    }
    ...
    private void LerpToPage(int aPageIndex)
    {
        ...
        _lerp = true;
        transform.GetChild(6).transform.GetChild(_currentPage).transform.localScale = new Vector3(0.5f, 0.5f, 0.5f);
        _currentPage = aPageIndex;
        transform.GetChild(6).transform.GetChild(_currentPage).transform.localScale = new Vector3(0.85f, 0.85f, 0.85f);
    }
